...
export const Route = createFileRoute("/dashboard/transactions/receipts")({
                ...
                <TableRow className="bg-gray-50">
                  <TableHead className="w-10 md:w-12">
                    <input
                      type="checkbox"
                      checked={
                        selectedRows.length === filteredReceipts.length &&
              ...
              <TableBody>
                {filteredReceipts.map((receipt) => (
                  <TableRow key={receipt.id} className="hover:bg-gray-50">
                    ...
                    <TableCell className="text-gray-600 whitespace-nowrap text-xs md:text-sm hidden md:table-cell">
                      {receipt.orderDate}
                    </TableCell>
                    <TableCell className="text-gray-600 whitespace-nowrap text-xs md:text-sm hidden lg:table-cell">
                      {receipt.property}
                    </TableCell>
                    <TableCell className="text-gray-600 font-mono text-xs md:text-sm whitespace-nowrap hidden xl:table-cell">
                      {receipt.trackingId}
                    </TableCell>
                    <TableCell className="font-semibold text-gray-900 whitespace-nowrap text-xs md:text-sm py-2 md:py-3">
                      {receipt.orderTotal}
                    </TableCell>
