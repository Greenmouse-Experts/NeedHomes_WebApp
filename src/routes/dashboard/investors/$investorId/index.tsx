            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
              ...
              <div className="flex-1">
                <div className="flex items-start justify-between">
                  <div>
                    <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">{investor.name}</h1>
                    <p className="text-sm text-gray-600 mb-4">Investor ID: {investor.id}</p>
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-4 border border-green-200">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold text-gray-900">{investor.totalInvestments}</p>
                </div>
              </div>
            </div>
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-4 border border-blue-200">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold text-gray-900">{investor.activeProperties}</p>
                </div>
              </div>
            </div>
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-4 border border-purple-200">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold text-gray-900">{investor.completedDeals}</p>
                </div>
              </div>
            </div>
          </div>
            ...
            {activeTab === 'overview' && (
              <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-medium text-gray-900">{investor.location}</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">{investor.bio}</p>
                  <div className="pt-4 space-y-3">
                    <Button 
                      variant="primary" 
                      className="w-full"
                      onClick={() => navigate({ to: '/dashboard/investors/$investorId/kyc', params: { investorId } })}
                    >
                      See KYC
                    </Button>
                ...
                {investor.properties.length > 0 ? (
                  <div className="overflow-x-auto">
                    <Table>
                      ...
                      <TableBody>
                        {investor.properties.map((property: any, index: number) => (
                          <TableRow key={index}>
                  ...
                  <div className="text-center py-12 bg-gray-50 rounded-lg">
                    <p className="text-gray-500">No properties found for this investor.</p>
                  </div>
                )}
              </div>
            )}
          ...
          <div className="p-6">
            ...
            <div className="overflow-x-auto">
              <Table>
                ...
                <TableBody>
                  <TableRow>
                    <TableCell className="text-xs text-gray-900">CUS-83927XJ</TableCell>
                    <TableCell className="text-xs text-gray-900">4BR Apartment, 10, Adeniji Street, Lagos</TableCell>
                    <TableCell className="text-xs text-gray-600">Outright</TableCell>
                    <TableCell>
                      <img
                    ...
                    <TableCell className="text-xs text-gray-900 font-medium">N 10,000,000</TableCell>
