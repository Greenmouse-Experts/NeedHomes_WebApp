          ...
          <form onSubmit={handleKycSubmit} className="max-w-3xl">
            ...
            <div className="space-y-2 mb-6">
              ...
              <Select
                ...
                onChange={(e) =>
                  setKycData((prev) => ({ ...prev, idType: e.target.value }))
                }
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="hidden"
                  onChange={(e) =>
                    handleFileUpload("frontUpload", e.target.files?.[0] || null)
                  }
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="hidden"
                  onChange={(e) =>
                    handleFileUpload("backUpload", e.target.files?.[0] || null)
                  }
                />
              </div>
            </div>
            ...
            <div className="space-y-2 mb-6">
              ...
              <input
                ...
                className="hidden"
                onChange={(e) =>
                  handleFileUpload("utilityBill", e.target.files?.[0] || null)
                }
              />
            </div>
            ...
            <div className="space-y-2 mb-6">
              ...
              <Input
                ...
                onChange={(e) =>
                  setKycData((prev) => ({ ...prev, address: e.target.value }))
                }
                className="bg-gray-50"
              />
            </div>
