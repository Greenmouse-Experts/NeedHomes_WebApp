...
import { ChevronLeft, MoreVertical, Phone, Mail, MapPin, Calendar, TrendingUp } from 'lucide-react'
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-orange-50 to-orange-100 p-6 md:p-8">
            <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
              ...
              <Avatar className="w-24 h-24 md:w-32 md:h-32 ring-4 ring-white shadow-lg">
                <AvatarImage src={partner.avatar} alt={partner.name} className="object-cover" />
              ...
              <div className="flex-1">
                <div className="flex items-start justify-between">
                  <div>
                    <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">{partner.name}</h1>
                    <p className="text-sm text-gray-600 mb-4">Partner ID: {partner.id}</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 p-6 md:p-8 border-b border-gray-200">
            <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-4 border border-green-200">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs text-gray-600 font-medium">Total Investments</p>
                  <p className="text-xl font-bold text-gray-900">{partner.totalInvestments}</p>
                </div>
              </div>
            </div>
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-4 border border-blue-200">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs text-gray-600 font-medium">Active Properties</p>
                  <p className="text-xl font-bold text-gray-900">{partner.activeProperties}</p>
                </div>
              </div>
            </div>
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-4 border border-purple-200">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs text-gray-600 font-medium">Completed Deals</p>
                  <p className="text-xl font-bold text-gray-900">{partner.completedDeals}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="p-6 md:p-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="pt-4 space-y-3">
                    <Button 
                      variant="primary" 
                      className="w-full"
                      onClick={() => navigate({ to: '/dashboard/partners/$partnerId/kyc', params: { partnerId } })}
                    >
                      See KYC
                    </Button>
            ...
            {activeTab === 'properties' && (
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Partnership Properties</h3>
                {partner.properties.length > 0 ? (
                    ...
                    <Table>
                      <TableHeader>
                        <TableRow className="bg-gray-50">
                          ...
                          <TableHead className="font-semibold hidden lg:table-cell">Package</TableHead>
                      ...
                      <TableBody>
                        {partner.properties.map((property: any, index: number) => (
                          <TableRow key={index}>
                            <TableCell className="font-medium text-sm">{property.sku}</TableCell>
                            <TableCell className="text-sm">{property.property}</TableCell>
                            <TableCell className="text-sm text-gray-600 hidden md:table-cell">{property.location}</TableCell>
                            <TableCell className="text-sm text-gray-600 hidden lg:table-cell">{property.package}</TableCell>
                            <TableCell className="text-sm font-semibold text-[var(--color-orange)]">{property.amount}</TableCell>
                            ...
                            <TableCell className="text-sm text-gray-600 hidden lg:table-cell">{property.date}</TableCell>
                          </TableRow>
                        ))}
                      </TableBody>
                    </Table>
                  ...
                  <div className="text-center py-12 bg-gray-50 rounded-lg">
                    <p className="text-gray-500">No properties found for this partner.</p>
                  </div>
                )}
              </div>
            )}
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
          <div className="p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Promoted Properties</h3>
              ...
              <Table>
                <TableHeader>
                  <TableRow className="bg-gray-50">
                    ...
                    <TableHead className="font-semibold text-xs">Property Description</TableHead>
                    <TableHead className="font-semibold text-xs">Package</TableHead>
                    <TableHead className="font-semibold text-xs">Image</TableHead>
                ...
                <TableBody>
                  <TableRow>
                    <TableCell className="text-xs text-gray-900">LAG-CAT-001</TableCell>
                    <TableCell className="text-xs text-gray-900">Semi Detached Duplex, Lekki Phase 1, Lagos</TableCell>
                    <TableCell className="text-xs text-gray-600">Outright Purchase</TableCell>
                    <TableCell>
                      <img
                    ...
                    <TableCell className="text-xs text-gray-900 font-medium">₦ 45,000,000</TableCell>
                  ...
                  <TableRow>
                    <TableCell className="text-xs text-gray-900">ABJ-RES-002</TableCell>
                    <TableCell className="text-xs text-gray-900">4 Bedroom Terrace, Gwarinpa, Abuja</TableCell>
                    <TableCell className="text-xs text-gray-600">Co-Development</TableCell>
                    <TableCell>
                      <img
                    ...
                    <TableCell className="text-xs text-gray-900 font-medium">₦ 32,000,000</TableCell>
