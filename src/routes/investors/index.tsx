    ...
    <div className="flex min-h-screen bg-gray-100">
      ...
      <aside className="fixed left-0 top-0 h-full w-64 bg-[#2A2A2A] text-white flex flex-col">
        ...
        <nav className="flex-1 overflow-y-auto p-3 space-y-1">
          <a href="/investors" className="flex items-center gap-2.5 p-2 rounded-lg bg-[var(--color-orange)] text-white text-sm">
          ...
          <a href="/investors/properties" className="flex items-center gap-2.5 p-2 rounded-lg hover:bg-gray-800 text-gray-400 text-sm transition-colors">
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
