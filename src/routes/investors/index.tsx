        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-r from-orange-400 via-orange-500 to-orange-600 rounded-xl md:rounded-2xl p-6 md:p-8 relative overflow-hidden shadow-lg">
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-xl md:text-3xl font-bold text-white mb-1 md:mb-2">Welcome, Lord Xylarz</h2>
              <p className="text-sm md:text-base text-white/90">Have a great day!</p>
            </div>
          </div>
            ...
            <div className="bg-white rounded-xl p-4 md:p-6 shadow-sm border border-gray-200">
              <div className="flex items-center gap-3 md:gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs md:text-sm text-gray-500 font-medium">Total Property</p>
                </div>
              </div>
            </div>
            <div className="bg-white rounded-xl p-4 md:p-6 shadow-sm border border-gray-200">
              <div className="flex items-center gap-3 md:gap-4">
                ...
                <div>
                  <p className="text-xl md:text-2xl font-bold text-gray-900">N 20,000,000</p>
                  <p className="text-xs md:text-sm text-gray-500 font-medium">Total Amount Paid</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="lg:col-span-2">
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                <div className="p-4 md:p-6 border-b border-gray-200">
                  <h3 className="text-base md:text-lg font-semibold text-gray-900">Recent Property</h3>
                </div>
                  ...
                  <div className="inline-block min-w-full align-middle px-4 md:px-0">
                    <table className="min-w-full divide-y divide-gray-200">
                      <thead className="bg-gray-50">
                        <tr>
                          <th className="px-3 md:px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">#</th>
                          <th className="px-3 md:px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Property Type</th>
                          <th className="px-3 md:px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Amount</th>
                          <th className="px-3 md:px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider hidden sm:table-cell">Date Added</th>
                      ...
                      <tbody className="bg-white divide-y divide-gray-200">
                        {recentProperties.map((property) => (
                          <tr key={property.id} className="hover:bg-gray-50 transition-colors">
                            <td className="px-3 md:px-6 py-3 md:py-4 text-xs md:text-sm text-gray-900 whitespace-nowrap">{property.id}</td>
                            <td className="px-3 md:px-6 py-3 md:py-4 text-xs md:text-sm text-gray-900 whitespace-nowrap">{property.type}</td>
                            <td className="px-3 md:px-6 py-3 md:py-4 text-xs md:text-sm text-gray-900 font-medium whitespace-nowrap">{property.amount}</td>
                            <td className="px-3 md:px-6 py-3 md:py-4 text-xs md:text-sm text-gray-500 hidden sm:table-cell whitespace-nowrap">{property.date}</td>
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                <div className="p-4 md:p-6 border-b border-gray-200 flex items-center justify-between">
                  <h3 className="text-base md:text-lg font-semibold text-gray-900">Wallet</h3>
                  <button className="text-xs md:text-sm text-gray-500 hover:text-gray-700 font-medium">Monthly ▼</button>
                </div>
                ...
                <div className="p-4 md:p-6">
                  <div className="grid grid-cols-2 gap-2 md:gap-3 mb-4">
                    <div className="bg-green-50 rounded-lg p-2 md:p-3 border border-green-200">
                      ...
                      <p className="text-base md:text-lg font-bold text-gray-900">N 100,000</p>
                    </div>
                    <div className="bg-red-50 rounded-lg p-2 md:p-3 border border-red-200">
                      ...
                      <p className="text-base md:text-lg font-bold text-gray-900">N 20,000</p>
                    </div>
                  </div>
                ...
                <div className="p-4 md:p-6 border-t border-gray-200">
                  ...
                  <div className="flex items-start gap-2 md:gap-3 p-2 md:p-3 bg-gray-50 rounded-lg">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-xs md:text-sm font-medium text-gray-900">Payment for Vendor reg</p>
                      <p className="text-xs text-gray-500 mt-1">01-02-25</p>
                    </div>
                    <div className="text-right">
                      <p className="text-xs md:text-sm font-semibold text-gray-900">+ N 200,000</p>
