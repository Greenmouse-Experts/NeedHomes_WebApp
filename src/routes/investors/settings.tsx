...
import { User, CreditCard, FileText, Shield, Upload, Bell, Menu } from "lucide-react";
          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="flex-1 p-4 md:p-6 lg:p-8">
              ...
              {activeTab === "profile" && (
                <div>
                  <div className="mb-4 md:mb-6">
                    <h3 className="text-xs md:text-sm font-semibold text-gray-500 uppercase mb-3 md:mb-4">PROFILE</h3>
                  </div>
                  ...
                  <form onSubmit={handleProfileSubmit} className="max-w-2xl">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mt-4 md:mt-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex gap-2">
                          <div className="w-12 md:w-16 flex items-center justify-center border border-gray-300 rounded-md flex-shrink-0">
                    ...
                    <div className="pt-4 md:pt-6">
                      <Button type="submit" className="bg-[var(--color-orange)] hover:bg-[var(--color-orange-dark)] text-white px-6 md:px-12 text-sm md:text-base w-full sm:w-auto">
                        Save
                      </Button>
                    </div>
                  </form>
              ...
              {activeTab === "bankDetails" && (
                <div>
                  <div className="mb-4 md:mb-6">
                    <h3 className="text-xs md:text-sm font-semibold text-gray-500 uppercase mb-3 md:mb-4">Bank Details</h3>
                  </div>
              ...
              {activeTab === "kyc" && (
                <div>
                  <div className="mb-4 md:mb-6">
                    <h3 className="text-xs md:text-sm font-semibold text-gray-500 uppercase mb-3 md:mb-4">KYC</h3>
                  </div>
                  ...
                  <form onSubmit={handleKycSubmit} className="max-w-2xl">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 md:p-8 text-center hover:border-[var(--color-orange)] transition-colors cursor-pointer">
                          ...
                          <label htmlFor="frontUpload" className="cursor-pointer">
                            ...
                            <p className="text-xs md:text-sm text-[var(--color-orange)]">View File Upload</p>
                          </label>
                        </div>
                      </div>
                    ...
                    {/* Utility Bill */}
                    <div className="space-y-2 mb-4 md:mb-6">
                      <Label className="text-sm">Utility Bill (Proof of Address)</Label>
                      <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 md:p-8 text-center hover:border-[var(--color-orange)] transition-colors cursor-pointer">
                        <input
                          type="file"
              ...
              {activeTab === "security" && (
                <div>
                  <div className="mb-4 md:mb-6">
                    <h3 className="text-xs md:text-sm font-semibold text-gray-500 uppercase mb-3 md:mb-4">Change Password</h3>
                  </div>

                  <form onSubmit={handlePasswordSubmit} className="max-w-2xl space-y-4 md:space-y-6">
                    {/* New Password */}
                    <div className="space-y-2">
