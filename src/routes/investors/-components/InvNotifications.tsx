...
import apiClient, { type ApiResponse, type ApiResponseV2 } from "@/api/simpleApi";
            ...
            {latest.length === 0 ? (
              ...
              latest.map((n) => (
                <div
                  ...
                  onClick={() => {
                    setOpen(false);
                    navigate({ to: "/investors/notifications" });
                  }}
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-gray-500 line-clamp-1 mt-0.5">{n.content}</p>
