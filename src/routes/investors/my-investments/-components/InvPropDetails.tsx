              ...
              <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="bg-gray-50 border border-gray-100 rounded-lg p-4">
                  ...
                  <ul className="mt-3 space-y-2 text-sm text-gray-700">
                    {prop_data.exitRule && (
                      <li>
                        <span className="font-medium">Exit Rule:</span>{" "}
                        <span className="ml-2">{prop_data.exitRule}</span>
                      </li>
                    )}
                    {prop_data.projectDuration && (
                      <li>
                        <span className="font-medium">Project Duration:</span>{" "}
                        <span className="ml-2">
                          {prop_data.projectDuration} months
                        </span>
                      </li>
                    )}
                    {prop_data.holdingPeriod && (
                      <li>
                        <span className="font-medium">Holding Period:</span>{" "}
                        <span className="ml-2">
                          {prop_data.holdingPeriod} months
                        </span>
                      </li>
                    )}
                    {prop_data.buyBackOption !== null && (
                      <li>
                        <span className="font-medium">Buy Back Option:</span>{" "}
                        <span className="ml-2">
                          {prop_data.buyBackOption
                            ? "Available"
                            : "Not Available"}
                        </span>
                      </li>
                    )}
                    {prop_data.savingsFrequency && (
                      <li>
                        <span className="font-medium">Savings Frequency:</span>{" "}
                        <span className="ml-2">
                          {prop_data.savingsFrequency}
                        </span>
                      </li>
                    )}
                    {prop_data.savingsDuration && (
                      <li>
                        <span className="font-medium">Savings Duration:</span>{" "}
                        <span className="ml-2">
                          {prop_data.savingsDuration} months
                        </span>
                      </li>
                    )}
                    {prop_data.profitSharingRatio && (
                      <li>
                    ...
                    {prop_data.totalShares && (
                      <li>
                        <span className="font-medium">Total Shares:</span>{" "}
                        <span className="ml-2">{prop_data.totalShares}</span>
                      </li>
                    )}
                    {prop_data.minimumShares && (
                      <li>
                        <span className="font-medium">Minimum Shares:</span>{" "}
                        <span className="ml-2">{prop_data.minimumShares}</span>
                      </li>
                    )}
                    {prop_data.exitWindow && (
                      <li>
                        <span className="font-medium">Exit Window:</span>{" "}
                        <span className="ml-2">
                          {prop_data.exitWindow} months
                        </span>
                      </li>
                    )}
                    {prop_data.installmentDuration && (
                      <li>
                        <span className="font-medium">
                          Installment Duration:
                        </span>{" "}
                        <span className="ml-2">
                          {prop_data.installmentDuration} months
                        </span>
                      </li>
                    )}
                    {prop_data.paymentOption && (
                      <li>
                      ...
                      prop_data.additionalFees.length > 0 && (
                        <li>
                          ...
                          <ul className="mt-2 ml-4 list-disc text-gray-700">
                            {prop_data.additionalFees.map((fee, idx) => (
                              <li key={idx}>
                                {typeof fee === "string"
                                  ? fee
                                  : JSON.stringify(fee)}
