...
export const Route = createFileRoute("/developer/properties/$propertyId/")({
                        ...
                        <Button
                          ...
                          onClick={() => {
                            ...
                            switch (item.investmentModel) {
                              case "CO_DEVELOPMENT":
                                nav({
                                  to: "/developer/properties/edit/$propertyId/co-dev",
                                  params: { propertyId: item.id },
                                });
                                break;
                              case "OUTRIGHT_PURCHASE":
                                nav({
                                  to: "/developer/properties/edit/$propertyId/outright",
                                  params: { propertyId: item.id },
                                });
                                break;
                              case "SAVE_TO_OWN":
                                nav({
                                  to: "/developer/properties/edit/$propertyId/save-to-own",
                                  params: { propertyId: item.id },
                                });
                                break;
                              case "LAND_BANKING":
                                nav({
                                  to: "/developer/properties/edit/$propertyId/land-bank",
                                  params: { propertyId: item.id },
                                });
                                break;
                              case "FRACTIONAL_OWNERSHIP":
                                nav({
                                  to: "/developer/properties/edit/$propertyId/fractional",
                                  params: { propertyId: item.id },
                                });
                                break;
                            }
