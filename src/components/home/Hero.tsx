      ...
      <Sectiongrid className="pt-12 lg:pt-0">
        <FlexInfo className="leading-loose text-left lg:text-left">
          ...
          <ul className="md:text-base text-sm space-y-3 mt-6">
            <li className="flex items-center gap-3">
              <span className="bg-red-500 text-white rounded-full w-4 h-4 flex items-center justify-center flex-shrink-0 text-xs">✓</span>
        ...
        <FlexInfo className="lg:justify-end justify-center flex-row items-center">
          <div className="relative size-8/10 flex items-center justify-center">
            {!isVideoPlaying ? (
              <div className="relative cursor-pointer group w-full h-full" onClick={() => setIsVideoPlaying(true)}>
                <img
                  src="/home_video.png"
