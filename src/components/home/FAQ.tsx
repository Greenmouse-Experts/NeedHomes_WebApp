          ...
          <FlexInfo className="text-center md:text-left">
            <div className="w-full md:max-w-5/6 space-y-4">
              <h2 className="text-3xl font-black">
                NEEDHOMES Frequently Asked Questions (FAQ)
              </h2>
              <p>
          ...
          <div>
            ...
            <div className="mt-6 text-center">
              <Button
                ...
                size="lg"
                onClick={() => {
                  navigate({ to: "/faqs", viewTransition: true });
                }}
              ...
              <div className="space-y-3">
                {questions.map((item, idx) => (
                  ...
                  >
                    <button
                      onClick={() =>
                        setModalOpenIndex(modalOpenIndex === idx ? null : idx)
                      }
                    ...
                    {modalOpenIndex === idx && (
                      <div className="p-4 bg-gray-50 border-t border-gray-200">
                        <p className="whitespace-pre-line text-sm md:text-base text-gray-700">
                          {item.a}
                        </p>
                      </div>
                    )}
